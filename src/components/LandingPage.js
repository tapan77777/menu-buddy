...
export default function MenuBuddyLanding() {
  ...
  <Link href="/login">
    <button className="bg-orange-600 text-white px-5 py-3 rounded-lg text-base font-semibold hover:bg-orange-700 transition flex items-center">
      For Restaurants <ChevronRight className="ml-1" size={18} />
    </button>
  </Link>
